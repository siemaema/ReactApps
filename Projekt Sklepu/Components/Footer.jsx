function Footer() {
  return (
    <footer className="bg-gray-800 text-white py-10 my-2">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-5">
        {/* O nas */}
        <div>
          <h3 className="text-lg font-semibold mb-2">O nas</h3>
          <p>
        ...
        {/* Pomoc i Wsparcie */}
        <div>
          <h3 className="text-lg font-semibold mb-2">Pomoc i Wsparcie</h3>
